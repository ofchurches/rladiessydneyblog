---
title: "Basic Basics Lesson 3: Loading Data"
...
#Basic Basics Lesson 3: Loading Data

In this lesson, we're going to review how to get data into RStudio, using a specially selected data file that we'll continue to use for many of the RYouWithMe lessons.
...
##3.1 Git the data! (get it?!)

For this lesson, you will need to visit the R-Ladies Sydney [Git page](https://github.com/rladiessydney/RYouWithMe). Download the sydneybeaches.csv data file using right click or control+click and selecting "Save link as". 

![](/post/2018-11-05-basicbasics-3_files/savedata.jpg)


Save the file to the data folder within your RYouWithMe folder. 

###An interlude: The Sydney Beaches Dataset
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/2MVolYETR5Q" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
No problem, there is a package for that! R can read in data from almost anywhere and any format. Learn more about reading data from...
...
That's it for Basic Basics (at least for now!). We hope you go and explore RStudio more while you wait for Unit 2 to drop!