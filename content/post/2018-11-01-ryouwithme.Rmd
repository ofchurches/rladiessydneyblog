...
We __strongly encourage__ you to join us over on our [Slack space](https://goo.gl/forms/MDqlAQfLRhhhCWbG3). There, you can join me and a cohort of fellow learners - and our generous teachers! We'll support one another, and build a network while we're at it! Even if you're joining us later down the track, the Slack space will be an invaluable resource for troubleshooting!
